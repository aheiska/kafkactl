...
func TestEnvironmentVariableLoadingAliases(t *testing.T) {
	...
	_ = os.Setenv(global.TLSCertKeyPassphrase, "my-cert-key-passphrase")
	...
	_ = os.Setenv(global.SchemaRegistryTLSCertKeyPassphrase, "my-schema-registry-cert-key-passphrase")
	...
	testutil.AssertEquals(t, "my-cert", viper.GetString("contexts.default.tls.cert"))
	testutil.AssertEquals(t, "my-cert-key", viper.GetString("contexts.default.tls.certKey"))
	testutil.AssertEquals(t, "my-cert-key-passphrase", viper.GetString("contexts.default.tls.certKeyPassphrase"))
	...
	testutil.AssertEquals(t, "my-schema-registry-cert-key-passphrase", viper.GetString("contexts.default.schemaRegistry.tls.certKeyPassphrase"))
...
func TestContextFlagAutoCompletion(t *testing.T) {
	...
	testutil.AssertArraysEquals(t, []string{"default", "k8s-mock", "no-schema-reg", "sasl-admin", "sasl-user", "scram-admin"}, outputLines[:len(outputLines)-1])
}
